                    ...
                    <div class="modal-content">
                        ...
                        <div id="carousel-${modalId}" class="carousel slide carousel-dark" data-bs-ride="carousel">
                            ...
                            <div class="carousel-item active">
                                <img src="https://grind-zone-api.vercel.app/${produto.img}" class="d-block w-75 mx-auto" alt="${produto.name} - Imagem 1">
                            </div>
                            <div class="carousel-item">
                                <img src="https://grind-zone-api.vercel.app/${produto.img}" class="d-block w-75 mx-auto" alt="${produto.name} - Imagem 2">
                            </div>
                            <div class="carousel-item">
                                <img src="https://grind-zone-api.vercel.app/${produto.img}" class="d-block w-75 mx-auto" alt="${produto.name} - Imagem 3">
                            </div>
                            </div>
